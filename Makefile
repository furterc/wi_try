...
OBJECTS += ./cmsg/cheader.o
OBJECTS += ./cmsg/cnode.o
OBJECTS += ./cmsg/control_one.o
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1549703391.31
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1549703391.31
