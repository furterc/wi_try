...
OBJECTS += ./src/DHT22.o
OBJECTS += ./src/InlineController.o
OBJECTS += ./src/InlineFan.o
OBJECTS += ./src/LCDController.o
OBJECTS += ./src/Relay.o
OBJECTS += ./src/ThresholdCheck.o
OBJECTS += ./src/linked_list.o
OBJECTS += ./src/main.o
OBJECTS += ./src/mqtt_interface.o
OBJECTS += ./src/nvm_config.o
OBJECTS += ./src/rtc_alarm.o


INCLUDE_PATHS += -I../.
INCLUDE_PATHS += -I.././EEP24xx16
...
INCLUDE_PATHS += -I.././src
INCLUDE_PATHS += -I..//home/christo/Projects/STM32/mbed/mbedhome/witry/mbed-os
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1554587344.79
C_FLAGS += -D__MBED__=1
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1554587344.79
...
ASM_FLAGS += -I../src
ASM_FLAGS += -I/home/christo/Projects/STM32/mbed/mbedhome/witry/mbed-os
ASM_FLAGS += -include
